...
nodemailer.createTestAccount((err, account) => {
    ...
    let transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'anggarabayuharles@gmail.com', // generated ethereal user
            pass: 'Zxcvbnm_87651234' // generated ethereal password
        }
    });
    ...
    let mailOptions = {
        ...
        to: 'bayuanggaraharles@gmail.com', // list of receivers
